...
# Create Zookeeper properties file for server 3
...
clientPort=2181
server.1=10.128.24.70:2888:3888
server.2=10.128.24.71:2888:3888
server.3=10.128.24.72:2888:3888
maxClientCnxns=0
EOF

# Create Kafka properties file for server 3
